...
;(function($w) {
    ...
    var jm = function(options) {
      ...
      custom_direction = opts.direction || 'LR'
      this.options = opts
      this.inited = false
      this.mind = null
      this.event_handles = []
      ...
      add_node: function(
        ...
        if (parent_node.isroot) {
          ...
          if (custom_direction === 'LR') {
            ...
            d = custom_direction === 'R' ? jm.direction.right : jm.direction.left
          }
  
          console.log(direction, d, custom_direction)
          node = new jm.node(
            nodeid,
            nodeindex,
            topic,
    ...
    jm.prototype = {
      ...
      update_node_manually: function(node) {
          console.log(node)
    ...
    jm.view_provider.prototype = {
      ...
      edit_node_end: function() {
        if (this.editing_node != null) {
          ...
          console.log('edit end','editing_node',this.editing_node)
